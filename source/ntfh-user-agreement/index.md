...
4.除双方另有约定外，用户使用通知助手上传、发布或传输内容即代表了用户有权且同意在全世界范围内，永久性的（除非用户主动删除或书面要求通知助手下线上述视频）、免费的授权我方：</br>
...
每一个注册的通知助手帐号最多在1台设备上登录，如果超出1台，会采取后登录端强制下线之前一登录端的形式继续登录。注册通知助手帐号之后，请合法使用帐号所拥有的权限，任何通过违法手段破解功能及影响通知助手服务的帐号，通知助手有权对帐号实施封禁。
